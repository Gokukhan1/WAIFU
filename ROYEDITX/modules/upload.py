...
from ROYEDITX import application, SUDO_USERS, CHANNEL_ID, SUPPORT_CHAT
from gridfs import GridFS 
from ROYEDITX import collection, user_collection, db
from io import BytesIO


import os
import requests
from ROYEDITX import ROY, collection
